/*
 * $Id: Main.java 2379 2005-12-09 09:23:12Z sim $
 *
...
//		added my amjad
		...
		System.out.println("AMLOG:: details:: " + details.getUsername());
		NetworkServiceImpl networkService = (NetworkServiceImpl) context.getBean("networkService");
		networkService.setUserDetails(details);
		System.out.println("AMLOG:: networkservice:: " + networkService.getUserSession());
		networkService.getUserSession().sendMessage("HI, i am here.");
// end
